...
server {
    ...
    server_name localhost;
    ssl_certificate /etc/nginx/default-server-cert/default_server.crt;
    ssl_certificate_key /etc/nginx/default-server-cert/default_server.key;
...
base_config = base_config + ssl_default_host + refuse_service + "\n}\n\n"
